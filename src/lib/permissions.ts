...
visit: {
  ...
  ipd: {},
  groomer: {
    view: ["ADMIN", "CLINIC_OWNER", "GROOMER", "RECEPTIONIST", "STAFF"],
    create: ["ADMIN", "CLINIC_OWNER", "GROOMER", "RECEPTIONIST"],
    update: ["ADMIN", "CLINIC_OWNER", "GROOMER"],
    complete: ["ADMIN", "CLINIC_OWNER", "GROOMER"],
    cancel: ["ADMIN", "CLINIC_OWNER", "GROOMER", "RECEPTIONIST"],
    delete: ["ADMIN", "CLINIC_OWNER"],
  },
  notification: {},
  auditLog: {},
